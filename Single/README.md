...
# 运行主程序
pycharm打开Single，
并配置interpreter为C:\Users\Administrator\AppData\Local\pypoetry\Cache\virtualenvs\dingtalk-langchain-S-m4SoKz-py3.12\Scripts
```
...
第一阶段：基础模块
从 Storage.py 开始，这是最简单的全局用户存储模块
学习 Prompt.py 理解提示词模板的构建方式
查看 init.py 了解模块导出结构
第二阶段：核心功能
学习 Emotion.py 理解情绪识别的实现
研究 Memory.py 掌握对话记忆管理
查看 Agents.py 理解AI代理的工作流程
第三阶段：集成和扩展
学习 DingWebHook.py 理解钉钉机器人集成
研究 Tools.py 了解各种工具的实现
查看 AddDoc.py 和 Server.py 理解文档处理API
