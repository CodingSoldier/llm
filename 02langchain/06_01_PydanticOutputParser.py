...
prompt = PromptTemplate(
    template="回答用户的查询.\n{formataaa_instructions}\n{query1}\n",
    input_variables=["query1"],
    partial_variables={"formataaa_instructions": parser.get_format_instructions()},
)

# 使用LCEL语法组合一个简单的链
prompt_and_model = prompt | llm
output = prompt_and_model.invoke({"query1": "给我讲一个笑话"})
